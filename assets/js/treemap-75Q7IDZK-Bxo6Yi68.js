import { bz as createAssigner, bA as isPrototype, aT as isArrayLike, bj as copyObject, aX as assignValue, aU as isArray, aA as baseRest, aB as isArrayLikeObject, b9 as baseAssignValue, bc as isObjectLike, bd as baseGetTag, ba as baseUnary, bo as nodeUtil, aD as isFunction, aE as isEmpty, aV as identity, aP as isObject, bB as __vitePreload } from './index-CwRyABEE.js';
import { k as keys, j as baseEach, g as baseIteratee, S as SetCache, w as arrayIncludes, x as cacheHas, c as baseFlatten, v as values, y as baseIndexOf, l as arrayMap, z as getAllKeysIn, A as arrayFilter, B as baseFilter, C as arraySome, a as baseUniq, d as forEach, i as isUndefined, r as reduce, f as filter, D as noop } from './_baseUniq-Dqp_F468.js';
import { j as toInteger, m as map, d as basePickBy, f as flatten, g as find, h as has, i as defaults, l as last, e as min } from './_basePickBy-ma-e3TRJ.js';
import { c as clone } from './clone-B2U_zqWP.js';
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await __vitePreload(async () => { const { createInfoServices: createInfoServices2 } = await Promise.resolve().then(() => info63CPKGFF);return { createInfoServices: createInfoServices2 }},true              ?void 0:void 0);
    const parser = createInfoServices2().Info.parser.LangiumParser;
    parsers.info = parser;
  }, "info"),
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await __vitePreload(async () => { const { createPacketServices: createPacketServices2 } = await Promise.resolve().then(() => packetHUATNLJX);return { createPacketServices: createPacketServices2 }},true              ?void 0:void 0);
    const parser = createPacketServices2().Packet.parser.LangiumParser;
    parsers.packet = parser;
  }, "packet"),
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await __vitePreload(async () => { const { createPieServices: createPieServices2 } = await Promise.resolve().then(() => pieWTHONI2E);return { createPieServices: createPieServices2 }},true              ?void 0:void 0);
    const parser = createPieServices2().Pie.parser.LangiumParser;
    parsers.pie = parser;
  }, "pie"),
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(async () => { const { createArchitectureServices: createArchitectureServices2 } = await Promise.resolve().then(() => architectureO4VJ6CD3);return { createArchitectureServices: createArchitectureServices2 }},true              ?void 0:void 0);
    const parser = createArchitectureServices2().Architecture.parser.LangiumParser;
    parsers.architecture = parser;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(async () => { const { createGitGraphServices: createGitGraphServices2 } = await Promise.resolve().then(() => gitGraphZV4HHKMB);return { createGitGraphServices: createGitGraphServices2 }},true              ?void 0:void 0);
    const parser = createGitGraphServices2().GitGraph.parser.LangiumParser;
    parsers.gitGraph = parser;
  }, "gitGraph"),
  radar: /* @__PURE__ */ __name(async () => {
    const { createRadarServices: createRadarServices2 } = await __vitePreload(async () => { const { createRadarServices: createRadarServices2 } = await Promise.resolve().then(() => radarNJJJXTRR);return { createRadarServices: createRadarServices2 }},true              ?void 0:void 0);
    const parser = createRadarServices2().Radar.parser.LangiumParser;
    parsers.radar = parser;
  }, "radar"),
  treemap: /* @__PURE__ */ __name(async () => {
    const { createTreemapServices: createTreemapServices2 } = await __vitePreload(async () => { const { createTreemapServices: createTreemapServices2 } = await Promise.resolve().then(() => treemap75Q7IDZK);return { createTreemapServices: createTreemapServices2 }},true              ?void 0:void 0);
...
export { parse as p };
//# sourceMappingURL=treemap-75Q7IDZK-Bxo6Yi68.js.map
